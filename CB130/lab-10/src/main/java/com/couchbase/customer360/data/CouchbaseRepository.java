...
//		}
	...
	public <T extends Entity> T create(T entity, Class<? extends T> type) {
		if(isBlank(entity.getId())) {
			/*
			 * TODO: Add code here to invoke the getNextId method and use the
			 *       return value to set the Id of the entity
			 */
		}
	...
	private <T extends Entity> String getNextId(Class<T> type, long incr, 
		long init) {
		/*
		 * TODO: Implement using the counter method of the bucket interface 
		 */
